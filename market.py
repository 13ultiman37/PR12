...
t1, rules = apriori(transactions, minSup=0.015, minConf=0.4)
...
rules = apriori2(transactions=transactions, min_support=0.015, min_confidence=0.4, min_lift=1.0001)
results = list(rules)
...
itemsets, rules = apriori3(transactions, min_support=0.015, min_confidence=0.4)
...
itemsets, rules = fpgrowth(transactions, minSupRatio=0.015, minConf=0.4)
